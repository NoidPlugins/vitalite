...
public class SailingAPI
{
    ...
    public static Heading getHeading()
    {
        return Static.invoke(() -> {
            ...
            return Heading.fromValue(toHeadingValue(rawValue));
        });
    }
    ...
    public static int getTargetHeadingValue()
    {
        return Static.invoke(() -> {
            ...
            if (boat == null)
                return -1;
            return toHeadingValue(boat.getTargetOrientation());
        });
    }
    ...
    {
        return toHeadingValue(VarAPI.getVar(VarbitID.SAILING_BOAT_SPAWNED_ANGLE));
    }
    ...
    private static int toHeadingValue(int rawValue)
    {
        if (rawValue < 0)
        {
            return -1;
        ...
        return Math.floorMod(rawValue, 2048) / 128;
    }
