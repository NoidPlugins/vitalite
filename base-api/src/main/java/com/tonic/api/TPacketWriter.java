...
public interface TPacketWriter
{
     ...
     * @param ctrl whether ctrl is pressed
     */
    default void objectActionPacket(int type, int identifier, int worldX, int worldY, boolean ctrl)
    {
        objectActionPacket(type, identifier, worldX, worldY, ctrl, 0);
    }

    /**
     * Sends an object action packet.
     *
     * @param type the zero-based action type
     * @param identifier the object identifier
     * @param worldX the world X coordinate
     * @param worldY the world Y coordinate
     * @param ctrl whether ctrl is pressed
     * @param subop the packed secondary option index, or 0 for normal actions
     */
     ...
     * @param ctrl whether ctrl is pressed
     */
    default void groundItemActionPacket(int type, int identifier, int worldX, int worldY, boolean ctrl)
    {
        groundItemActionPacket(type, identifier, worldX, worldY, ctrl, 0);
    }
     ...
     * @param ctrl whether ctrl is pressed
     */
    default void npcActionPacket(int type, int npcIndex, boolean ctrl)
    {
        npcActionPacket(type, npcIndex, ctrl, 0);
    }
